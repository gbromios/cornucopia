...
import com.gb.cornucopia.cookery.block.TileEntityPresser;
...
public class GuiPresser extends GuiContainer {
	...
	public GuiPresser(World world, InventoryPlayer player_inventory, BlockPos pos) {
		// will this crash if the wrong kind of tile entity is there? probably lol
		super(new ContainerPresser(player_inventory, (IInventory)world.getTileEntity(pos)));
		// find out for sure!!
