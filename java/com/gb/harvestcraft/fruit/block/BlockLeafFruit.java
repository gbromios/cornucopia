...
public class BlockLeafFruit extends BlockLeaves {
	...
	public BlockLeafFruit(String name){
		super();
	...
	public void setGrows(EnumType woodType, BlockCropFruit crop){
		this.woodType = woodType; // yeah i dont think I'm actually using this for anything but I might as well hook it up in case vanilla has other ideas
		this.crop = crop;
	}
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random rand){
		...
		world.setBlockState(pos.down(), this.crop.getDefaultState());
